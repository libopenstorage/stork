...
require (
	...
	github.com/portworx/kdmp v0.4.1-0.20210905185157-02d8c708c3ab
...
replace (
	...
	github.com/kubernetes-incubator/external-storage => github.com/libopenstorage/external-storage v0.20.4-openstorage-rc4
