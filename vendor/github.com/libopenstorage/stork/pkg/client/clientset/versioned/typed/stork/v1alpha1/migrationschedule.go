...
func (c *migrationSchedules) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.MigrationSchedule, err error) {
...
func (c *migrationSchedules) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.MigrationScheduleList, err error) {
...
func (c *migrationSchedules) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *migrationSchedules) Create(ctx context.Context, migrationSchedule *v1alpha1.MigrationSchedule, opts v1.CreateOptions) (result *v1alpha1.MigrationSchedule, err error) {
	result = &v1alpha1.MigrationSchedule{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("migrationschedules").
...
func (c *migrationSchedules) Update(ctx context.Context, migrationSchedule *v1alpha1.MigrationSchedule, opts v1.UpdateOptions) (result *v1alpha1.MigrationSchedule, err error) {
	result = &v1alpha1.MigrationSchedule{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("migrationschedules").
...
func (c *migrationSchedules) UpdateStatus(ctx context.Context, migrationSchedule *v1alpha1.MigrationSchedule, opts v1.UpdateOptions) (result *v1alpha1.MigrationSchedule, err error) {
	result = &v1alpha1.MigrationSchedule{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("migrationschedules").
...
func (c *migrationSchedules) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *migrationSchedules) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *migrationSchedules) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.MigrationSchedule, err error) {
	result = &v1alpha1.MigrationSchedule{}
