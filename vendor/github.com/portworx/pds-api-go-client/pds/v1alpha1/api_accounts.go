...
type ApiApiAccountsIdPatchRequest struct {
	...
	ApiService *AccountsApiService
	id string
	body *ControllersUpdateAccountRequest
}

// Request body containing the name. .
func (r ApiApiAccountsIdPatchRequest) Body(body ControllersUpdateAccountRequest) ApiApiAccountsIdPatchRequest {
	r.body = &body
	return r
}

func (r ApiApiAccountsIdPatchRequest) Execute() (*ModelsAccount, *http.Response, error) {
	return r.ApiService.ApiAccountsIdPatchExecute(r)
}

/*
ApiAccountsIdPatch Update Account
...
// Execute executes the request
//  @return ModelsAccount
func (a *AccountsApiService) ApiAccountsIdPatchExecute(r ApiApiAccountsIdPatchRequest) (*ModelsAccount, *http.Response, error) {
	var (
