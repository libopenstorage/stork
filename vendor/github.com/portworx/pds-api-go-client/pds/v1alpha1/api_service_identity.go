...
func (r ApiApiServiceIdentityIdPutRequest) Execute() (*ModelsServiceIdentity, *http.Response, error) {
...
// Execute executes the request
//  @return ModelsServiceIdentity
func (a *ServiceIdentityApiService) ApiServiceIdentityIdPutExecute(r ApiApiServiceIdentityIdPutRequest) (*ModelsServiceIdentity, *http.Response, error) {
	var (
