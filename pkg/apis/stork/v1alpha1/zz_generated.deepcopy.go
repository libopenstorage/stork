...
func (in *ActionParameter) DeepCopyInto(out *ActionParameter) {
	*out = *in
	in.FailoverParameter.DeepCopyInto(&out.FailoverParameter)
	in.FailbackParameter.DeepCopyInto(&out.FailbackParameter)
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ActionParameterItem) DeepCopyInto(out *ActionParameterItem) {
	*out = *in
	in.FailoverParameter.DeepCopyInto(&out.FailoverParameter)
	in.FailbackParameter.DeepCopyInto(&out.FailbackParameter)
	return
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ActionParameterItem.
func (in *ActionParameterItem) DeepCopy() *ActionParameterItem {
	if in == nil {
		return nil
	}
	out := new(ActionParameterItem)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ActionSpec) DeepCopyInto(out *ActionSpec) {
	*out = *in
	in.ActionParameter.DeepCopyInto(&out.ActionParameter)
	return
}
...
func (in *ActionSummary) DeepCopyInto(out *ActionSummary) {
	*out = *in
	if in.FailoverSummaryItem != nil {
		in, out := &in.FailoverSummaryItem, &out.FailoverSummaryItem
		*out = make([]*FailoverSummary, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(FailoverSummary)
				**out = **in
			}
		}
	}
	if in.FailbackSummaryItem != nil {
		in, out := &in.FailbackSummaryItem, &out.FailbackSummaryItem
		*out = make([]*FailbackSummary, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(FailbackSummary)
				**out = **in
			}
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ActionSummaryItem) DeepCopyInto(out *ActionSummaryItem) {
	*out = *in
	if in.FailoverSummaryItem != nil {
		in, out := &in.FailoverSummaryItem, &out.FailoverSummaryItem
		*out = make([]*FailoverSummary, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ActionSummaryItem.
func (in *ActionSummaryItem) DeepCopy() *ActionSummaryItem {
	if in == nil {
		return nil
	}
	out := new(ActionSummaryItem)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ApplicationBackupScheduleSpec) DeepCopyInto(out *ApplicationBackupScheduleSpec) {
	*out = *in
	...
	if in.ParallelBackup != nil {
		in, out := &in.ParallelBackup, &out.ParallelBackup
		*out = new(bool)
		**out = **in
	}
	return
...
func (in *ApplicationBackupVolumeInfo) DeepCopyInto(out *ApplicationBackupVolumeInfo) {
	*out = *in
	...
	out.JobSecurityContext = in.JobSecurityContext
	return
}
...
func (in *ApplicationResource) DeepCopyInto(out *ApplicationResource) {
	*out = *in
	out.GroupVersionKind = in.GroupVersionKind
	out.SuspendOptions = in.SuspendOptions
	if in.NestedSuspendOptions != nil {
		in, out := &in.NestedSuspendOptions, &out.NestedSuspendOptions
		*out = make([]SuspendOptions, len(*in))
		copy(*out, *in)
	}
	out.StashStrategy = in.StashStrategy
	return
}
...
func (in *ClusterItem) DeepCopyInto(out *ClusterItem) {
	*out = *in
	if in.AWSClusterConfig != nil {
		in, out := &in.AWSClusterConfig, &out.AWSClusterConfig
		*out = new(S3Config)
		**out = **in
	}
	if in.AzureClusterConfig != nil {
		in, out := &in.AzureClusterConfig, &out.AzureClusterConfig
		*out = new(AzureConfig)
		**out = **in
	}
	if in.GCPClusterConfig != nil {
		in, out := &in.GCPClusterConfig, &out.GCPClusterConfig
		*out = new(GoogleConfig)
		**out = **in
	}
	return
...
func (in *ClusterPairSpec) DeepCopyInto(out *ClusterPairSpec) {
	*out = *in
	...
	in.PlatformOptions.DeepCopyInto(&out.PlatformOptions)
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FailbackParameter) DeepCopyInto(out *FailbackParameter) {
	*out = *in
	if in.FailbackNamespaces != nil {
		in, out := &in.FailbackNamespaces, &out.FailbackNamespaces
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	return
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FailbackParameter.
func (in *FailbackParameter) DeepCopy() *FailbackParameter {
	if in == nil {
		return nil
	}
	out := new(FailbackParameter)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FailbackSummary) DeepCopyInto(out *FailbackSummary) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FailbackSummary.
func (in *FailbackSummary) DeepCopy() *FailbackSummary {
	if in == nil {
		return nil
	}
	out := new(FailbackSummary)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FailoverParameter) DeepCopyInto(out *FailoverParameter) {
	*out = *in
	if in.FailoverNamespaces != nil {
		in, out := &in.FailoverNamespaces, &out.FailoverNamespaces
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.SkipSourceOperations != nil {
		in, out := &in.SkipSourceOperations, &out.SkipSourceOperations
		*out = new(bool)
		**out = **in
	}
	return
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FailoverParameter.
func (in *FailoverParameter) DeepCopy() *FailoverParameter {
	if in == nil {
		return nil
	}
	out := new(FailoverParameter)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FailoverSummary) DeepCopyInto(out *FailoverSummary) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FailoverSummary.
func (in *FailoverSummary) DeepCopy() *FailoverSummary {
	if in == nil {
		return nil
	}
	out := new(FailoverSummary)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *JobSecurityContext) DeepCopyInto(out *JobSecurityContext) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new JobSecurityContext.
func (in *JobSecurityContext) DeepCopy() *JobSecurityContext {
	if in == nil {
		return nil
	}
	out := new(JobSecurityContext)
	in.DeepCopyInto(out)
	return out
}
...
func (in KindResourceTransform) DeepCopyInto(out *KindResourceTransform) {
	{
		in := &in
		*out = make(KindResourceTransform, len(*in))
		for key, val := range *in {
			var outVal []TransformResourceInfo
			if val == nil {
				(*out)[key] = nil
			} else {
				in, out := &val, &outVal
				*out = make([]TransformResourceInfo, len(*in))
				for i := range *in {
					(*in)[i].DeepCopyInto(&(*out)[i])
				}
			}
...
func (in *MigrationSpec) DeepCopyInto(out *MigrationSpec) {
	*out = *in
	...
	if in.IncludeNetworkPolicyWithCIDR != nil {
		in, out := &in.IncludeNetworkPolicyWithCIDR, &out.IncludeNetworkPolicyWithCIDR
		*out = new(bool)
		**out = **in
	}
	if in.Selectors != nil {
	...
	if in.SkipDeletedNamespaces != nil {
		in, out := &in.SkipDeletedNamespaces, &out.SkipDeletedNamespaces
		*out = new(bool)
		**out = **in
	}
	...
	if in.ExcludeResourceTypes != nil {
		in, out := &in.ExcludeResourceTypes, &out.ExcludeResourceTypes
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	return
...
func (in *MigrationStatus) DeepCopyInto(out *MigrationStatus) {
	*out = *in
	...
	in.FinishTimestamp.DeepCopyInto(&out.FinishTimestamp)
	in.VolumeMigrationFinishTimestamp.DeepCopyInto(&out.VolumeMigrationFinishTimestamp)
	in.ResourceMigrationFinishTimestamp.DeepCopyInto(&out.ResourceMigrationFinishTimestamp)
	if in.Summary != nil {
		in, out := &in.Summary, &out.Summary
...
func (in *NamespacedSchedulePolicy) DeepCopy() *NamespacedSchedulePolicy {
	...
	out := new(NamespacedSchedulePolicy)
	in.DeepCopyInto(out)
	return out
}
...
func (in *NamespacedSchedulePolicyList) DeepCopy() *NamespacedSchedulePolicyList {
	...
	out := new(NamespacedSchedulePolicyList)
	in.DeepCopyInto(out)
	return out
}
...
func (in *PatchStruct) DeepCopyInto(out *PatchStruct) {
	*out = *in
	if in.Resources != nil {
		in, out := &in.Resources, &out.Resources
		*out = make(map[string]TransformResourceInfo, len(*in))
		for key, val := range *in {
...
func (in *PlatformCredentialSpec) DeepCopyInto(out *PlatformCredentialSpec) {
	*out = *in
	if in.RancherConfig != nil {
		in, out := &in.RancherConfig, &out.RancherConfig
		*out = new(RancherConfig)
		**out = **in
	}
	return
}
...
func (in *RancherSpec) DeepCopyInto(out *RancherSpec) {
	*out = *in
	if in.ProjectMappings != nil {
		in, out := &in.ProjectMappings, &out.ProjectMappings
		*out = make(map[string]string, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
...
func (in *ResourceTransformationList) DeepCopy() *ResourceTransformationList {
	...
	out := new(ResourceTransformationList)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ResourceTransformationSpec) DeepCopyInto(out *ResourceTransformationSpec) {
	*out = *in
	if in.Objects != nil {
		...
		*out = make([]TransformSpecs, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *ResourceTransformationSpec) DeepCopy() *ResourceTransformationSpec {
	...
	out := new(ResourceTransformationSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ResourceTransformationStatus) DeepCopy() *ResourceTransformationStatus {
	...
	out := new(ResourceTransformationStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *TransformSpecPatch) DeepCopyInto(out *TransformSpecPatch) {
	*out = *in
	if in.GVK != nil {
		...
		*out = make(map[string]PatchStruct, len(*in))
		for key, val := range *in {
			(*out)[key] = *val.DeepCopy()
		}
	}
