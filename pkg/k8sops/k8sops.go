...
// K8sOps is an interface to perform any kubernetes related operations
type K8sOps interface {
	...
	K8sPodOps
	K8sStorageClassOps
	K8sPersistentVolumeClaimOps
}

// K8sNamespaceOps is an interface to perform namespace operations
type K8sNamespaceOps interface {
...
// K8sNodeOps is an interface to perform k8s node operations
type K8sNodeOps interface {
...
// K8sServiceOps is an interface to perform k8s service operations
type K8sServiceOps interface {
...
// K8sStatefulSetOps is an interface to perform k8s stateful set operations
type K8sStatefulSetOps interface {
...
type K8sDeploymentOps interface {
...
// K8sStorageClassOps is an interface to perform k8s storage class operations
type K8sStorageClassOps interface {
...
// K8sPersistentVolumeClaimOps is an interface to perform k8s PVC operations
type K8sPersistentVolumeClaimOps interface {
