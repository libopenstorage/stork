...
func (c *groupVolumeSnapshots) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.GroupVolumeSnapshot, err error) {
...
func (c *groupVolumeSnapshots) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.GroupVolumeSnapshotList, err error) {
...
func (c *groupVolumeSnapshots) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *groupVolumeSnapshots) Create(ctx context.Context, groupVolumeSnapshot *v1alpha1.GroupVolumeSnapshot, opts v1.CreateOptions) (result *v1alpha1.GroupVolumeSnapshot, err error) {
	result = &v1alpha1.GroupVolumeSnapshot{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("groupvolumesnapshots").
...
func (c *groupVolumeSnapshots) Update(ctx context.Context, groupVolumeSnapshot *v1alpha1.GroupVolumeSnapshot, opts v1.UpdateOptions) (result *v1alpha1.GroupVolumeSnapshot, err error) {
	result = &v1alpha1.GroupVolumeSnapshot{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("groupvolumesnapshots").
...
func (c *groupVolumeSnapshots) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *groupVolumeSnapshots) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *groupVolumeSnapshots) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.GroupVolumeSnapshot, err error) {
	result = &v1alpha1.GroupVolumeSnapshot{}
