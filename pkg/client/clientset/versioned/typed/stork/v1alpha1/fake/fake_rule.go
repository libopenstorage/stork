...
var rulesResource = schema.GroupVersionResource{Group: "stork.openstorage.org", Version: "v1alpha1", Resource: "rules"}

var rulesKind = schema.GroupVersionKind{Group: "stork.openstorage.org", Version: "v1alpha1", Kind: "Rule"}
