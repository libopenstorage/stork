...
func (c *clusterPairs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ClusterPair, err error) {
...
func (c *clusterPairs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ClusterPairList, err error) {
...
func (c *clusterPairs) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *clusterPairs) Create(ctx context.Context, clusterPair *v1alpha1.ClusterPair, opts v1.CreateOptions) (result *v1alpha1.ClusterPair, err error) {
	result = &v1alpha1.ClusterPair{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("clusterpairs").
...
func (c *clusterPairs) Update(ctx context.Context, clusterPair *v1alpha1.ClusterPair, opts v1.UpdateOptions) (result *v1alpha1.ClusterPair, err error) {
	result = &v1alpha1.ClusterPair{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("clusterpairs").
...
func (c *clusterPairs) UpdateStatus(ctx context.Context, clusterPair *v1alpha1.ClusterPair, opts v1.UpdateOptions) (result *v1alpha1.ClusterPair, err error) {
	result = &v1alpha1.ClusterPair{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("clusterpairs").
...
func (c *clusterPairs) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *clusterPairs) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *clusterPairs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ClusterPair, err error) {
	result = &v1alpha1.ClusterPair{}
