...
func (c *applicationBackupSchedules) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ApplicationBackupSchedule, err error) {
...
func (c *applicationBackupSchedules) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ApplicationBackupScheduleList, err error) {
...
func (c *applicationBackupSchedules) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *applicationBackupSchedules) Create(ctx context.Context, applicationBackupSchedule *v1alpha1.ApplicationBackupSchedule, opts v1.CreateOptions) (result *v1alpha1.ApplicationBackupSchedule, err error) {
	result = &v1alpha1.ApplicationBackupSchedule{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("applicationbackupschedules").
...
func (c *applicationBackupSchedules) Update(ctx context.Context, applicationBackupSchedule *v1alpha1.ApplicationBackupSchedule, opts v1.UpdateOptions) (result *v1alpha1.ApplicationBackupSchedule, err error) {
	result = &v1alpha1.ApplicationBackupSchedule{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("applicationbackupschedules").
...
func (c *applicationBackupSchedules) UpdateStatus(ctx context.Context, applicationBackupSchedule *v1alpha1.ApplicationBackupSchedule, opts v1.UpdateOptions) (result *v1alpha1.ApplicationBackupSchedule, err error) {
	result = &v1alpha1.ApplicationBackupSchedule{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("applicationbackupschedules").
...
func (c *applicationBackupSchedules) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *applicationBackupSchedules) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *applicationBackupSchedules) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ApplicationBackupSchedule, err error) {
	result = &v1alpha1.ApplicationBackupSchedule{}
