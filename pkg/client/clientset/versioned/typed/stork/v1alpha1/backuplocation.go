...
func (c *backupLocations) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.BackupLocation, err error) {
...
func (c *backupLocations) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.BackupLocationList, err error) {
...
func (c *backupLocations) Create(ctx context.Context, backupLocation *v1alpha1.BackupLocation, opts v1.CreateOptions) (result *v1alpha1.BackupLocation, err error) {
	result = &v1alpha1.BackupLocation{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("backuplocations").
...
func (c *backupLocations) Update(ctx context.Context, backupLocation *v1alpha1.BackupLocation, opts v1.UpdateOptions) (result *v1alpha1.BackupLocation, err error) {
	result = &v1alpha1.BackupLocation{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("backuplocations").
...
func (c *backupLocations) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.BackupLocation, err error) {
	result = &v1alpha1.BackupLocation{}
