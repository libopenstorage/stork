...
// ClusterDomainUpdateInformer provides access to a shared informer and lister for
...
func (f *clusterDomainUpdateInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&storkv1alpha1.ClusterDomainUpdate{}, f.defaultInformer)
}

func (f *clusterDomainUpdateInformer) Lister() v1alpha1.ClusterDomainUpdateLister {
	return v1alpha1.NewClusterDomainUpdateLister(f.Informer().GetIndexer())
}
